...
# ''' khởi tạo list bai12a với bai12 giá trị , khởi tạo i , i trong phạm vi từ 0 đến bai12 thì sẽ có từ 0 đến bai12-1 giá trị'''
...
# A = np.arange(4)
# print('A =', A)
# #tạo một ma trận có 12 giá trị tính từ 0 , gồm 6 hàng 2 cột
